...
class UserController {
  ...
  async adicionarEndereco({ request, auth }) {
    ...
    var vendedor_atual = await Vendedor.findByOrFail("usr_vd_id", user.id);
  ...
  async cadastrar({ request }) {
    ...
    // Definindo image padrão para usuario
    dados_usuario.image =
      "https://assets.entrepreneur.com/franchise/avatar/282279.png";
